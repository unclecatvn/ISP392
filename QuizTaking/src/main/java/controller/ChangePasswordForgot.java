...
public class ChangePasswordForgot extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        dao.removeForgotKey(email);
        request.setAttribute("mess", "Your password has been changed, please login again");
        request.getRequestDispatcher("login-google").forward(request, response);
    }
