...
public class ManageClass extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        ArrayList<Classes> list = cdb.getAllClass();
        ArrayList<Classes> listT = cdb.getAllTakenClass();
        ArrayList<User> listTe = cdb.listAssignTeacher();
        ArrayList<User> listSt = cdb.listAssignStudent();
        ArrayList<Course> listCourse = course.getAllCourse();
