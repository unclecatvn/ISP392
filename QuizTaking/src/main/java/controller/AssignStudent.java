...
public class AssignStudent extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AssignStudent</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AssignStudent at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
   ...
   @Override
    ...
    throws ServletException, IOException {
            ...
            int teacherId = c.getTeacherIdOfClass(classId, courseId);
            c.assignStudent(classId, courseId, studentId, teacherId);
